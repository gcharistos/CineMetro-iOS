...
@implementation ContainerGreenViewController
...
- (void)goToNextView{
    ...
    PageContentGreenViewController *startingViewController = [self viewControllerAtIndex:currentIndex];
    NSArray *viewControllers = @[startingViewController];
...
//Creates page view
- (PageContentGreenViewController *)viewControllerAtIndex:(NSUInteger)index
{
...
{
    NSUInteger index = [((PageContentGreenViewController*) viewController) pageIndex];
    if (index == 0) {
        return nil;
    }
    index--;
